...
Status: local test candidate `0.2.3`. Native browser verification for this candidate is pending. The previous `0.2.0` release was tested unpacked in Chrome and Vivaldi. It is not published in the Chrome Web Store.
