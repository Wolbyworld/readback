...
export function validateQuizShape(quiz, questionCount, optionCount, imageRefs, level = "apply") {
  ...
  if (typeof quiz.title !== "string" || !quiz.title.trim()) return "The quiz has no usable title.";
  if (typeof quiz.source_summary !== "string" || !quiz.source_summary.trim()) return "The quiz has no usable summary.";
  return null;
}
